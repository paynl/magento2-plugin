...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    protected $methodCodes = [
        ...
        'paynl_payment_babycadeaubon',
        'paynl_payment_bancomat',
        'paynl_payment_bataviacadeaukaart',
        'paynl_payment_bbqcadeaukaart',
        'paynl_payment_beautycadeau',
        'paynl_payment_beautyandmorecadeaukaart',
        ...
        'paynl_payment_fashionchequebeauty',
        ...
        'paynl_payment_huisdierencadeaukaart',
        ...
        'paynl_payment_nationalegolfbon',
        'paynl_payment_nationaletuinbon',
        'paynl_payment_nexi',
