...
define(
    ...
    function ($, Component, url, placeOrderAction, quote) {
        ...
        return Component.extend({
            ...
            defaults: {
                template: 'Paynl_Payment/payment/instore'
            },
            ...
            isVisible: function () {
                if (this.getIpaddress() == true && this.getUseragent() == true) {
                    return true;
                }
            ...
            getIpaddress: function () {
                return window.checkoutConfig.payment.showforipaddress[this.item.method];
            },

            getUseragent: function () {
                return window.checkoutConfig.payment.showforuseragent[this.item.method];
            },
